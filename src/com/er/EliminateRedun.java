...
public static class ERMap extends Mapper<Object,Text,Text,TextArrayWritable>{
	...
	public static class ERReduce extends Reducer<Text,TextArrayWritable,Text,Text> {
		...
		public boolean isMustCompare(String valueOne,String valueTwo){
			...
			for(String entityOneAttr : entityOneAttrs){
				set.add(entityOneAttr);
			}
			
			for(String entityTwoAttr : entityTwoAttrs){
				if(set.add(entityTwoAttr)==false)
					return false;
			}
...
//			return true;
	...
	public static void main(String[] args) throws IOException, ClassNotFoundException, InterruptedException
	{
		...
		job.setJarByClass(EliminateRedun.class);
		...
		FileInputFormat.setInputPaths(job,new Path("hdfs://192.168.38.100:9000/user/longge/ER/20.txt"));
